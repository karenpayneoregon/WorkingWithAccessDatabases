Public Class Form1
    ...
    Private Sub CategoryListBox_SelectedIndexChanged(
        sender As Object, e As EventArgs) Handles CategoryListBox.SelectedIndexChanged
        MovePosition()
    End Sub
    ''' <summary>
    ''' Put filter in place for current category by category identifier
    ''' </summary>
